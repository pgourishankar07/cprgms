...
int main() {
  ...
  int *ptrTrial =
      new int[3]; // For Dynamically allocating memory for 3 integers, first it
                  //  will point the 1st index ,then u need to increament ptr_in
                  //  to store next next values,works very similar to array
                  //  pointers
