...
int main() {
    ...
    //_______________to print no. of times each char present____________________________________
    string s, s2;
    cout << "enter a string :" << endl;
    getline(cin, s);
    for (int i = 0; i < s.length(); i++) {
    ...
    cout << s2;
    //_______________to print the char which comes maximum times____________________________________
