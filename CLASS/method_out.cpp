...
// ADDITION
void arithmetic::sum(int num1, int num2)
{
    cout << "Sum of numbers :" << num1 + num2 << endl;
};

// Subtraction
void arithmetic::sub(int num1, int num2)
{
    cout << "Subtraction of numbers :" << num1 - num2 << endl;
};
// Multiplication
void arithmetic::multi(int num1, int num2)
{
    cout << "Multiplication of numbers :" << num1 * num2 << endl;
};
// Division
void arithmetic::divi(float num1, float num2)
{
